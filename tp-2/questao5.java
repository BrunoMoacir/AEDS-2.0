...
public class questao5{
    public static void main(String[] args) throws Exception{
        ...
        // primeira parte: ler os ids e preencher o array ate -1
        while(sc.hasNext()){
            ...
            int id = Util.paraInt(idBusca);// converto a string id para numero

            for(int i = 0; i < col.getTamanho(); i++){
                if(col.getRestaurantes()[i].getId() == id){// procuro o id no arquivo 
                    array[n++] = col.getRestaurantes()[i];// guardo quando acho
                    break;
                }
            }
        }
